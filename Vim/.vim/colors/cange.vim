...
" {{{
    ...
    hi MatchParen       guifg=#ffdf00           guibg=NONE           gui=bold
    hi MatchParen       ctermfg=220             ctermbg=234             cterm=bold
    ...
    hi Search           guifg=#afdf00           guibg=#005f5f           gui=none
    hi Search           ctermfg=148             ctermbg=23              cterm=none
